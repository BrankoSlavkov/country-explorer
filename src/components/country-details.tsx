...
export const CountryDetails = forwardRef<HTMLDivElement, CountryDetailsProps>(
  function CountryDetails({ countryName }, ref) {
      ...
      <div ref={ref} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <InfoCard title="Additional Info" icon="ℹ️">
            ...
            {country.fifa && (
              <InfoItem label="FIFA Code" value={country.fifa} />
            )}
